-- Read-side projections (query side). Live in the SAME database as the event log.
-- NOTE: the events read-model is named `events_projection` to avoid colliding with
-- the event-log `events` table above.

-- ═══════════════════════════════════════════════════════════════════════════
-- Events read model (concerts/shows)
-- ═══════════════════════════════════════════════════════════════════════════
...
CREATE INDEX idx_events_projection_owner ON events_projection (owner_id);
CREATE INDEX idx_events_projection_status ON events_projection (status);
CREATE INDEX idx_events_projection_date ON events_projection (event_date);
